...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $2}')
ipsaya=$(wget -qO- ifconfig.me)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini"
checking_sc() {
...
U2=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $6}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $5}')
cd
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/Jatimpark/vip/install/main/issue.net" &> /dev/null
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Jatimpark/vip/main/menu/install-up.sh &> /dev/null
