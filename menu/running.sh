...
Exp=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
Name2=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $2}')
