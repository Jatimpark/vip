...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Jatimpark/vip/main/install/nginx.conf"
...
wget -q https://raw.githubusercontent.com/Jatimpark/vip/main/install/ipserver && chmod +x ipserver && ./ipserver
