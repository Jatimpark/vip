...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini >/dev/null 2>&1
...
LIST=$(curl -sS https://raw.githubusercontent.com/Jatimpark/license/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/Jatimpark/license/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/Jatimpark/license/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/Jatimpark/license/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/Jatimpark/license/main/key | grep $kode | awk '{print $6}')
cd
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/Jatimpark/license/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
res1() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/r1.sh && chmod +x r1.sh && ./r1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/Jatimpark/v1/main/install/c2.sh && chmod +x c2.sh && ./cr2.sh
clear
}
res4() {
wget https://raw.githubusercontent.com/Jatimpark/v1/main/install/r3.sh && chmod +x r3.sh && ./r3.sh
clear
}
clear
cd
...
clear
wget https://raw.githubusercontent.com/Jatimpark/vip/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}
...
res9() {
wget https://raw.githubusercontent.com/Jatimpark/vip/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Jatimpark/permission/main/ipmini | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Jatimpark/vip/main/versi  )
